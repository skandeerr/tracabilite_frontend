...
import { EditMatiere, deleteMatiereById, getMatiere, getMatiereById, saveMatiere } from '../../api/matiere';
...
const Export = () => {
    ...
    const [matiereToBeAdd, setMatiereToBeAdd] = useState({
        tonnage :0,
        ref : ""
    });
        ...
        setInitialRecords(() => {
            return rowData.filter((item: any) => {
                return (
                    ...
                    item.tonnage.toString().toLowerCase().includes(search.toLowerCase()) 
                );
            });
        });
    }, [search]);
    ...
    const getMatieres =(id:any,type:string)=>{
        getMatiereById(id)
    ...
    const deleteRow = async (id: any) => {
        if (id) {
          try {
            await deleteMatiereById(id ).then((response) => {
    ...
    const addMatiere = ()=>{
        if(matiereToBeAdd.ref!="" && matiereToBeAdd.tonnage!=0){
            saveMatiere(matiereToBeAdd)
            .then(res=>{
             if(res){
                showMessage('Matiere ajoutée avec Succès.');
    ...
    const updateMatiere = ()=>{
        if(matiereToBeAdd.ref!="" && matiereToBeAdd.tonnage!=0){
            EditMatiere(matiere.id,matiereToBeAdd)
            .then(res=>{
             if(res){
                showMessage('Matiere modifié avec Succès.');
  ...
  <span>Listes des matieres premieres</span>
  <button className="btn btn-primary text-white px-2 py-1 rounded-md" type='button' onClick={()=>setShowModalAdd(true)}> <span className='text-sm'>Ajouter</span></button>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'ref',title:'Reference', sortable: true },
                            { accessor: 'tonnage',title:'Tonnage', sortable: true },
                            
                            {
                                accessor: 'Actions',
                                title: 'Actions',
                                render: ({ id }) => <div className="mx-auto ml-3 flex w-max items-center gap-4">
                                     <button  className="flex hover:text-info" type='button' onClick={()=>{getMatieres(id,"edit")}}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4.5 w-4.5">
                                ...
                                ></path>
                                    ...
                                    <button type="button" className="flex hover:text-danger" onClick={()=>{setShowModal(true);getMatieres(id,"")}}>
            ...
            <Transition appear show={showModalAdd} as={Fragment}>
                    <Dialog as="div" open={showModalAdd} onClose={() => {setShowModalAdd(false);setHasChange(false);setMatiereToBeAdd({
                                 tonnage :0,
                                 ref : ""
                        ...
                        <div className="fixed inset-0 overflow-y-auto">
                            <div className="flex min-h-full items-center justify-center px-4 py-8">
                                ...
                                >
                                    <Dialog.Panel className="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                        <button
                                            type="button"
                                            onClick={() => {setShowModalAdd(false);setHasChange(false);setMatiereToBeAdd({
                                                tonnage :0,
                                                ref : ""
                                            })}}
                          ...
                          <div className="mt-4">
                            <div
                              className={
                                hasChange && matiereToBeAdd.ref==="" ? "has-error" : ""
                              }
                            >
                              ...
                              <input
                                type="text"
                                onChange={(e:any)=>{
                                    setMatiereToBeAdd({ ...matiereToBeAdd, ref: e.target.value })
                                }}
                                className="form-input"
                                placeholder="reference *"
                                
                              />
                             {hasChange && matiereToBeAdd.ref==="" && (
                        ...
                        <div className=" mb-5">
                          <div className="mt-4">
                            <div
                              className={
                                hasChange && matiereToBeAdd.tonnage===0 ? "has-error" : ""
                              }
                            >
                              <label>Tonnage *</label>
                              <input
                                type="number"
                                onChange={(e:any)=>{
                                    setMatiereToBeAdd({ ...matiereToBeAdd, tonnage: e.target.value })
                                }}
                                className="form-input"
                                placeholder="tonnage *"
                                
                              />
                              {hasChange && matiereToBeAdd.tonnage===0 && (
                                <p className="text-red-500">
                                  Ce champ  est requis
                                </p>
                              )}
                        ...
                        <div className=" mx-20 inline-flex gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-1 ">
                          <button
                            ...
                            onClick={()=>{setHasChange(true);addMatiere()}}
                          ...
                          <button
                            ...
                            onClick={()=>{setHasChange(false);setMatiereToBeAdd({
                                tonnage :0,
                                ref : ""
                            });setShowModalAdd(false)}}
                          >
                ...
                <Transition appear show={showModalEdit} as={Fragment}>
                    <Dialog as="div" open={showModalEdit} onClose={() => {setShowModalEdit(false);setHasChange(false);setMatiereToBeAdd({
                                 tonnage :0,
                                 ref : ""
                            })}} className="relative z-50">
                        <Transition.Child
                            ...
                            <div className="flex min-h-full items-center justify-center px-4 py-8">
                                ...
                                >
                                    <Dialog.Panel className="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                        <button
                                            type="button"
                                            onClick={() => {setShowModalEdit(false);setHasChange(false);setMatiereToBeAdd({
                                                tonnage :0,
                                                ref : ""
                                           })}}
                                            className="absolute top-4 text-gray-400 outline-none hover:text-gray-800 ltr:right-4 rtl:left-4 dark:hover:text-gray-600"
                          ...
                          <div className="mt-4">
                            ...
                            >
                              ...
                              <input
                                ...
                                defaultValue={matiereToBeAdd.ref}
                                className="form-input"
                                placeholder="reference *"
                          ...
                          <div className="mt-4">
                            ...
                            >
                              ...
                              <input
                                ...
                                defaultValue={matiereToBeAdd.tonnage}
                                className="form-input"
                                placeholder="tonnage *"
                        ...
                        <div className=" mx-20 inline-flex gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-1 ">
                          <button
                            ...
                            type="button"
                            className="  btn btn-success  gap-2"
                            onClick={()=>{setHasChange(true);updateMatiere()}}
                    ...
                    <div className="mt-2 text-center sm:ml-4 sm:text-left px-6">
                      ...
                      <div className="p-6 text-center">
                        ...
                        <h4 className="mb-5 font-normal text-gray-500 dark:text-gray-400">
                          Êtes-vous sûr(e) de vouloir supprimer cette matiere ?
                        </h4>
                        <button
                          onClick={(e) => deleteRow(matiere.id)}
                          data-modal-hide="popup-modal"
                          type="button"
