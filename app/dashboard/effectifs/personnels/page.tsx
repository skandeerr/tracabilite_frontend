...
const col = ['id', 'email', 'fullName', 'role', 'numero', 'machine'];
...
const Export = () => {
  ...
  <span>Listes des personnels</span>
  <button className="btn btn-primary text-white px-2 py-1 rounded-md" type='button' onClick={()=>router.push("/dashboard/effectifs/personnels/add")}> <span className='text-sm'>Ajouter</span></button>
</div>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'fullName',title: 'Nom et prenom', sortable: true },
                            { accessor: 'email',title: 'Email', sortable: true },
                            { accessor: 'numero', title: 'Numero', sortable: true },
                            { accessor: 'machine', title: 'Machine', sortable: true },
                            { accessor: 'role', title: 'Role', sortable: true,render: ({ role }) =><div> {role==="ADMIN"?<div>Administrateur</div> : role==="CHEF_EQUIPE" ?<div>Chef d'équipe </div> :role==="RESPONSABLE_PRODUCTION" ?<div>Responsable Production</div> :""   }</div> },
